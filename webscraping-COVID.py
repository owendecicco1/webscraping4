...
for row in table_rows[2:52]:
    ...
    death_rate = round(float(total_deaths)/float(total_cases) * 100,2)
    test_rate = round(float(total_tests)/float(population) * 100,2)
...
print()
print()
print(f"State with the best death rate: {state_best_test}")
...
#make integer and THEN get rid of commas
